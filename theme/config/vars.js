...
vars.JS_LINK = '<script src="{f:uri.resource(path:"js/%_file_%", extensionName: "{site.identifier}")}"></script>'
vars.CSS_LINK = '<link rel="stylesheet" type="text/css" href="{f:uri.resource(path:"css/%_file_%", extensionName: "{site.identifier}")}"></link>'
